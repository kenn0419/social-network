...
@Component
public class Oauth2GoogleUserInfoExtractor implements OAuth2UserInfoExtractor {
    @Override
    public CustomUserDetails extractUserInfo(OAuth2User oAuth2User) {
        return CustomUserDetails.builder()
                ...
                .provider(Oauth2ProviderEnum.GOOGLE)
    ...
    public boolean accepts(OAuth2UserRequest userRequest) {
        return Oauth2ProviderEnum.GOOGLE.name().equalsIgnoreCase(userRequest.getClientRegistration().getRegistrationId());
    }
